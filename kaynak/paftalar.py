...
def kesit_icerik(ad, ox, oz, s=10.0):
    ...
    with kayit.katman("DOSEME-KESIT"):
...
def _cati_kesit(c, T, e, cut, L):
    ...
    with kayit.katman("CATI-TASIYICI"):
...
def _merdiven_gorunus(c, T, cut):
    ...
    for kat in ("Bodrum", "Zemin"):
        ...
        k1, k2 = mk["kollar"]
        r = mk["riht"]
        with kayit.katman("MERDIVEN-GOR"):
            # batı kol (ön planda)
            pts = [(k1[2], z0)]
            for i in range(k1[4]):
                y = k1[2] + i * b
